...
MIN_COHESIVE_GEOMETRY_THICKNESS = 0.001
...
def execute(pluginDir='C:\\Users\\Binz\\Desktop\\Undelivered _pro\\prototypeApp', cmdType='createModel', mLength=150, mWidth=100, mHeight=1.025, mThickness=0.125, mNumLayer=5, mLayerAngle='45/0/-45/90/45/0/-45/90/45/0/-45/90/45/0/-45/90/90/-45/0/45/90/-45/0/45/90/-45/0/45/90/-45/0/45', mPitDiameter=10, mMaterialFileKw='C:/Users/Binz/Desktop/Undelivered _pro/prototypeApp/material.json', mOdbFileKw='', modifyType=0, tbWidth=20, tbHeight=20, tbLayerNum=4, tbLayerAngle='0/10/20/40', glueThickness=0.00001, jtNum=4, xjAngle=10, lrGap=1.2, tbGap=1.2, disValue=1000, jobName='Job-1', numOfCpus=1, mSubroutineFileKw='', parseOdbType=0, tableKw=(), matParaDict='{"material":{"adhesive":{"power":1.45,"de":[2.058,2.563,2.563],"qd":[122,136,136],"elastic":[100000,100000,100000],"density":1.2e-09},"base":{"depvar":90,"data":[126000,10400,10400,0.312,0.312,0.45,4500,4500,3280,0,0.06,1,1,1,1,1,1,1,2076,1357,50.9,187,55.4,150,1,1,66,66,66,1,1,1,1,1,20,10,0.1,1,1],"density":1.522e-09},"cohesiveZero":{"power":1.45,"de":[2.058,2.563,2.563],"qd":[122,136,136],"elastic":[100000,100000,100000],"density":1.2e-09}}}', tbType=0, tbShape=0, pressBC=0):
    ...
    "inputCohesive":glueThickness,
    "cohesive":geometryGlueThickness, #是否内聚力层"
    "layers":layerAngle,
    "r": mPitDiameter, #缺陷半径
    "numOfCpus":numOfCpus,
    ...
    "modify":{
        ...
        "inputCohesive":glueThickness,
        "cohesive":geometryGlueThickness, #胶接厚度
        "tbShape":tbShape,
        "tbType":tbType,
